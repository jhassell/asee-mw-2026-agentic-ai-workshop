...
One task, done three ways, then once more on something of yours, then one
change to a course you teach.
...
| 6 | [`keep-it-running.md`](keep-it-running.md) | How to keep this environment after today, for about ten dollars. |

## Also here, to take home
...
| `what-went-wrong.md` | The candid list from our Summer 2026 course. Added to this folder before the session. |
